...
if __name__ == "__main__":
    ...
    os.makedirs('taskc_output', exist_ok=True)
    # Iterate through all the images of the dataset
    for idx, img_path in enumerate(sorted(glob.glob(f'{taskc_path}/*.jpg'))):
        ...
        cv2.imwrite(f'taskc_output/{idx}.png', out.get_image()[:, :, ::-1])
